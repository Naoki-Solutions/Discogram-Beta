...
if(isset($_POST['crear_servidor'])) {
    ...
    // Crear archivo PHP
    $file_path = "./servers/" . $server_id . ".php"; // Ruta del archivo PHP
    $template = file_get_contents("./components/plantilla.php"); // Contenido de la plantilla PHP
...
header("Location: ./servers/$server_id.php");
exit;
