<div class="column-2-2">
            <a href="./settings-account.php"><h4 style="top:1rem"><i class="fa-solid fa-circle-info"></i> Ajustes de Cuenta</h4></a>
            ...
            <a href="./debug.php"><h4 style="top:15rem"><i class="fa-solid fa-bug"></i> Debug Panel</h4></a>
