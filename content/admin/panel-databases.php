...
<body>
        ...
        <a href="./panel.php"><h4 style="top:1rem"><i class="fa-solid fa-arrow-left"></i> Back</h4></a>
<?php include('../../assets/php/components/2-2-panel.php')?>
</div>
        <div class="column-3">
        <h2 style="padding-left:15px;">Admin Panel</h2>
            ...
            <h3 style="padding-left:15px;">Discogram Structure</h3>
        <?php include('../../assets/php/display-dbs-panel.php')?>
        </div>
